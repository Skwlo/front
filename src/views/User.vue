<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="please enter名称" suffix-icon="el-icon-search" v-model="username"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="role" label="角色">
        <template slot-scope="scope">
          ...
          <el-tag type="success" v-if="scope.row.role === 'ROLE_USER'">user</el-tag>
        </template>
      </el-table-column>
