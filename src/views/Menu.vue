...
<!--  后台菜单管理-->
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="please enter名称" suffix-icon="el-icon-search" v-model="name"></el-input>
<!--      <el-input style="width: 200px" placeholder="please enter邮箱" suffix-icon="el-icon-message" class="ml-5" v-model="email"></el-input>-->
<!--      <el-input style="width: 200px" placeholder="please enter地址" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column label="operation"  width="300" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="handleAdd(scope.row.id)" v-if="!scope.row.pid && !scope.row.path">add子菜单 <i class="el-icon-plus"></i></el-button>
